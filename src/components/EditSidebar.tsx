...
const EditSidebar: React.FC<EditSidebarProps> = ({ isOpen, onClose }) => {
  ...
  // Using a ref to store the timeout so we can clear it on mouse leave
  ...
  const handleCo2MouseEnter = () => {
    setShowCo2Immediate(true); // Show placeholder immediately on hover
  ...
  // Helper to determine if an oval is selected
